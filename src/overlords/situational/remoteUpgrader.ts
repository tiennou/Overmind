...
const dontLoot: ResourceConstant[] = [RESOURCE_ENERGY];
...
const LOOTING_ORDER: ResourceConstant[] = [
	...highPriorityLoot,
	...everythingElse,
	...lowPriorityLoot,
];
...
export class RemoteUpgradingOverlord extends Overlord {
	...
	constructor(
		directive: DirectiveRemoteUpgrade,
	...
	private computeNeededCarrierCapacity(): number {
		...
		const roundTripDistance =
			1.5 /* todo */ * this.directive.distanceFromPOI.terrainWeighted;
